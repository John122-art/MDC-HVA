...
class ArgoPreprocAV2():
    ...
    def process(self,
        ...
        for traj_pos, traj_ang, traj_vel in zip(trajs_pos, trajs_ang, trajs_vel):
            ...
            #
            trajs_rot.append(rot_act)
            act_orig1 = traj_pos[self.args.obs_len - 1]
            act_orig2 = traj_pos[self.args.obs_len - 5]
            act_vecyaw = act_orig1 - act_orig2
        ...
        # collect data
        data = [[seq_id, city_name, orig_seq, rot_seq, trajs, lane_graph, Theta, trajs_rot]]
        headers = ["SEQ_ID", "CITY_NAME", "ORIG", "ROT", "TRAJS", "LANE_GRAPH", "THETA", "TRAJS_ROT"]
    ...
    def get_lane_graph(self,
        ...
        lane_ctrs, lane_vecs, lane_yaws, lane_rot = [], [], [], []
        NUM_SEG_POINTS = 10
